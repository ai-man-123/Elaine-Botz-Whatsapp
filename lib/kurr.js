...
const ownerNumber = "60102810046@s.whatsapp.net"
...
if(budy.includes('aiman')){
cpref = `Hayo Ngomongin aiman Ganteng Yaaa Aowkowkwoo`
reply(cpref)
}
if(budy.includes('rikka')){
cpref = `Hayo Ngomongin rikka Ganteng Yaaa Aowkowkwoo`
reply(cpref)
}
           if (budy.startsWith('>')){
...
└─────────────────❒`
sendButLocation(from, `${menu}`, "*_© Aimanゑ_*", {jpegThumbnail:ofrply2,name:""}, [{buttonId:`store`,buttonText:{displayText:'aiman STORE'},type:1},{buttonId:`sc`,buttonText:{displayText:'ＳＥＷＡ　ＢＯＴ'},type:1},{buttonId:`catalog`,buttonText:{displayText:'CATALOG MENU'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
...
GITHUB OWNER:https://github.com/ai-man-123
YOUTUBE OWNER:https://youtube.com/-`
sendButLocation(from, `${menu}`, "*_© aimanゑ_*", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`allmenu`,buttonText:{displayText:'ALL MENU'},type:1},{buttonId:`store`,buttonText:{displayText:'KURRXD STORE'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
else if(menusimpel = true){
        stod = `${sender}`
fill =`Hai Kak ${pushname}, ${tampilUcapan}
